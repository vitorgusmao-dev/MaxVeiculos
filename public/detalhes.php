...
// Obter fotos do veículo (ordenadas por ordem ASC - capa primeiro)
                ...
                <div class="gallery-container">
                    <?php if (!empty($fotos)): ?>
                        <div id="lightgallery">
                            ...
                            <a href="<?php echo BASE_URL; ?>/public/uploaded_images/<?php echo $fotos[0]['caminho_foto']; ?>" data-lg-size="1200-675">
                                <img src="<?php echo BASE_URL; ?>/public/uploaded_images/<?php echo $fotos[0]['caminho_foto']; ?>" alt="<?php echo $veiculo['modelo']; ?>" class="main-image">
                            </a>

                            <!-- Thumbnails: apenas as fotos restantes (ignorar a primeira) -->
                            <?php if (count($fotos) > 1): ?>
                                <div class="gallery">
                                    <?php for ($i = 1; $i < count($fotos); $i++): ?>
                                        <a href="<?php echo BASE_URL; ?>/public/uploaded_images/<?php echo $fotos[$i]['caminho_foto']; ?>" data-lg-size="1200-675" class="gallery-thumb">
                                            <img src="<?php echo BASE_URL; ?>/public/uploaded_images/<?php echo $fotos[$i]['caminho_foto']; ?>" alt="<?php echo $veiculo['modelo']; ?>">
                                        </a>
                                    <?php endfor; ?>
                                </div>
                            <?php endif; ?>
